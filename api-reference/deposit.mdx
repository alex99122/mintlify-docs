...
<ParamField path="game" type="integer" required>
  Game id: `440` (TF2), `730` (CS2), `570` (Dota 2), `252490` (Rust), `753` (Steam).
</ParamField>
...
TF2 / CS2 / Dota / Rust / Steam may add game-specific fields (`unusual`, `wear`, `stickers`, etc.). See existing **Items** docs for field meanings.
...
<ParamField body="game" type="integer">
  Default `440`. Must be one of `440`, `730`, `570`, `252490`, `753`.
</ParamField>
...
<ParamField path="game" type="integer" required>
  Game id: `753` (Steam), `440` (TF2), or `252490` (Rust).
</ParamField>
...
<ParamField body="game" type="integer">
  Default `440`. Must be one of `753`, `440`, `252490`.
</ParamField>

**Supported games:** `753` (Steam), `440` (TF2), `252490` (Rust).

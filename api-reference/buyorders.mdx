...
```json Success
{
  ...
  "data": {
    "buyOrderId": 98765,
    "refundedBalance": 80000,
    "message": "Buy order removed successfully"
  }
}
```
...
| `quantityFilled` | integer | Number of items already purchased |
| `quantityRemaining` | integer | Number of items still needed |
| `totalReserved` | integer | Total balance reserved for remaining quantity |

...
<Columns cols={2}>
  ...
  <Card title="Cart" icon="cart-shopping" href="/api-reference/cart">
  ...
  <Card title="User Account" icon="user" href="/api-reference/user">
    Account info, balance, sessions, store profile, and history.
  </Card>
  <Card title="Vendor Webhooks" icon="webhook" href="/api-reference/webhooks-vendor">
    Vendor webhook integrations for marketplace partners.
  </Card>
</Columns>
